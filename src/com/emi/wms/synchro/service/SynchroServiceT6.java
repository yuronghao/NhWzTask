...
import com.emi.wms.synchro.dao.SynchroDaoT6;
import com.emi.wms.synchro.dao.SynchroDaoU890;
import com.emi.wms.util.Constants;
import com.emi.wms.util.DateUtil;

public class SynchroServiceT6 extends EmiPluginService implements Serializable {

	private static final long serialVersionUID = -2162597524027074596L;
	private SynchroDaoT6 synchroDaoT6;
	
	public void setSynchroDaoT6(SynchroDaoT6 synchroDaoT6) {
		this.synchroDaoT6 = synchroDaoT6;
	}
	...
	public void synchroInventoryClass(String orgGid,String sobGid){
		synchroDaoT6.deleteInventoryClass();//删除存货分类
		synchroDaoT6.addInventoryClass();//增加存货分类
		synchroDaoT6.updInventoryClass();//修改存货分类
		synchroDaoT6.updInventoryClassParentGid();//指定父id
		synchroDaoT6.updInventoryClassOrgSob(orgGid, sobGid);//指定帐套 组织
	}
	...
	public void synchroInventory(String orgGid,String sobGid){
		synchroDaoT6.deleteInventory();//删除存货档案
		synchroDaoT6.addInventory();//增加存货档案
		synchroDaoT6.updInventory();//修改存货档案
		synchroDaoT6.updInventoryInfor();//修改相关属性
		synchroDaoT6.updInventoryOrgSob(orgGid, sobGid);//指定帐套组织
	}
	...
	public void synchroDepartment(String orgGid,String sobGid){
		synchroDaoT6.deleteDepartment();//删除部门
		synchroDaoT6.addDepartment();//增加部门
		synchroDaoT6.uptDepartment();//修改部门
		synchroDaoT6.uptDepartmentParentGid();//修改自关联字段
		synchroDaoT6.updDepartmentOrgSob(orgGid, sobGid);//指定帐套组织
	}
...
//	}
	...
	public void synchroWareHouse(String orgGid,String sobGid){
		synchroDaoT6.deleteWareHouse();//删除仓库
		synchroDaoT6.addWareHouse();//增加仓库
		synchroDaoT6.updWareHouse();//修改仓库
		synchroDaoT6.updWareHouseOrgSob(orgGid, sobGid);
	}
	...
	public void synchroGoodsAllocation(String orgGid,String sobGid){
		...
		synchroDaoT6.addGoodsAllocation();//增加货位
		synchroDaoT6.updGoodsAllocation();//修改货位
		synchroDaoT6.updGoodsAllocationInfor();//修改相关属性
		synchroDaoT6.updGoodsAllocationOrgSob(orgGid, sobGid);
	}
	...
	public void synchroUnit(String orgGid,String sobGid){
		synchroDaoT6.deleteUnit();//删除单位
		synchroDaoT6.addUnit();//增加单位
		synchroDaoT6.updUnit();//修改单位
		synchroDaoT6.updUnitOrgSob(orgGid, sobGid);//指定组织 帐套
	}
...
//	}
	...
	public void synchroUser(String orgGid,String sobGid){
		synchroDaoT6.addUser();//增加用户
		synchroDaoT6.updUser();//修改用户
		synchroDaoT6.updUserOrgSob(orgGid, sobGid);//指定组织 帐套
	}
	...
	public void synchroPerson(String orgGid,String sobGid){
		synchroDaoT6.deletePerson();//删除人员
		synchroDaoT6.addPerson();//增加人员
		synchroDaoT6.updPerson();//修改人员
		synchroDaoT6.updPersonInfor();//修改相关属性
		synchroDaoT6.updPersonOrgSob(orgGid, sobGid);//指定组织 帐套
	}
...
//	}
	...
	public void synchroProduceOrder(String orgGid,String sobGid){
		//////////////////////////////////////////////////////////////////////////////////////////处理订单主表
		synchroDaoT6.deleteProduceOrder();//删除生产订单主表
		synchroDaoT6.addProduceOrder();//增加生产订单主表
		synchroDaoT6.updProduceOrder();//修改生产订单主表
		synchroDaoT6.updProduceOrderInfor();//修改生产订单主表相关字段
		
		//////////////////////////////////////////////////////////////////////////////////////////处理订单产品表
		synchroDaoT6.deleteProduceOrderC();//删除生产订单产品表
		synchroDaoT6.addProduceOrderC();//增加生产订单产品表
		synchroDaoT6.updProduceOrderC();//修改生产订单产品表
		synchroDaoT6.updProduceOrderCInfor();//修改生产订单产品表相关字段
		
		//////////////////////////////////////////////////////////////////////////////////////////处理订单材料表
		synchroDaoT6.deleteProduceOrderC2();//删除生产订单材料表
		synchroDaoT6.addProduceOrderC2();//增加生产订单材料表
		synchroDaoT6.updProduceOrderC2();//修改生产订单材料表
		synchroDaoT6.updProduceOrderC2Infor();//修改相关字段
		
		synchroDaoT6.updProduceOrderOrgSob(orgGid, sobGid);//指定组织 帐套
