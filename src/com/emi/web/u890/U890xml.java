...
import com.emi.web.u890.bean.TransvouchBodyU8;
import com.emi.web.u890.bean.TransvouchHeadU8;
	...
	public static String getStoreOutBodyXml(StoreOutBodyU8 storeOutBody){
		...
		String chilid=
	            "<entry>"+
	                ...
	                "<free1>"+(CommonUtil.isNullObject(storeOutBody.getCfree1())?"":storeOutBody.getCfree1())+"</free1>"+
	                "<free2>"+(CommonUtil.isNullObject(storeOutBody.getCfree2())?"":storeOutBody.getCfree2())+"</free2>"+
	                "<free3 />"+
	                "<free4 />"+
	                "<free5 />"+
	                "<free6 />"+
	                ...
	                "<assitantunit>"+(CommonUtil.isNullObject(storeOutBody.getCsTComUnitCode())?"":storeOutBody.getCsTComUnitCode())+"</assitantunit>"+
	                "<assitantunitname>"+(CommonUtil.isNullObject(storeOutBody.getCsTComUnitName())?"":storeOutBody.getCsTComUnitName())+"</assitantunitname>"+
	                ...
	                "<plancost />"+
	                "<planprice />"+
	                "<serial>"+(CommonUtil.isNullObject(storeOutBody.getBatch())?"":storeOutBody.getBatch())+"</serial>"+
	                "<makedate />"+
	                "<validdate />"+
	                "<transitionid />"+
	                "<subbillcode />"+
	                ...
	                "<define28 />"+
	                "<define29 />"+
	                "<define30>"+storeOutBody.getDefine30()+"</define30>"+
	                "<define31></define31>"+
	                "<define32 />"+
	                "<define33></define33>"+
	                "<define34 />"+
