...
<body>
<form id="myform">
<input type="hidden" id="parentid" name="parentid" value="${orgclassid}">
		 		...
		 		<div class="xz_attribute">
		 			<ul>
		 				...
		 				<li>
		 					...
		 					<div class="fl div_ipt">
		 						<input type="text" id="orgAdder" name="orgAdder" >
		 					</div>
		 					<div class="cf"></div>
		 				</li>
		 				<li>
		 				...
		 				<li>
		 					...
		 					<div class="fl div_ipt">
		 						<input type="text" id="orgMoboile" name="orgMoboile" >
		 					</div>
		 					<div class="cf"></div>
		 				</li>
		 				<li>
		 				...
		 				<li>
		 					...
		 					<div class="fl div_ipt">
		 						<input type="text" id="orgUrls" name="orgUrls" >
		 					</div>
		 					<div class="cf"></div>
		 				</li>
		 				<li>
		 					...
		 					<div class="fl div_ipt">
		 						<input type="text" id="orgUrl" name="orgUrl" >
		 					</div>
		 					<div class="cf"></div>
		 				</li>
		 				<li>
