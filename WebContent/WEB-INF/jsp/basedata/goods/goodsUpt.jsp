		 		...
		 		<div class="createdList" style="height:80%;">
		 			...
		 			<ul class="wordul">
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="hidden"  id="goodsGid" name="goodsGid" value="${aaGoods.gid }">
								<input type="text"  id="goodsCode" name="goodsCode" value="${aaGoods.goodscode }">
							</div>
							<div class="cf"></div> 
		 				</li>
		 				<li class="wordli fl">
							<div class="wordname fl">物料名称：</div>
							<div class="wordnameinput fl"><input type="text"  id="goodsName" name="goodsName" value="${aaGoods.goodsname }"> </div>
							<div class="cf"></div> 
		 				</li>
		 				<li class="wordli fl">
							<div class="wordname fl">规格型号：</div>
							<div class="wordnameinput fl"><input type="text"  id="goodsStandard" name="goodsStandard" value="${aaGoods.goodsstandard }"> </div>
							<div class="cf"></div> 
		 				</li>
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="hidden"  id="goodsUnitGid" name="goodsUnitGid" value="${aaGoods.goodsunit }" >
								<input type="text"  id="goodsUnitName" name="goodsUnitName" value="${aaGoods.unitName }" >
							 </div>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="hidden" value="${aaGoods.casscomunitcode }" id="cassComUnitGid" name="cassComUnitGid"> 
								<input type="text" value="${aaGoods.cassComUnitName }" id="cassComUnitName" name="cassComUnitName" readonly="readonly">
							</div>
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl"><input type="text" value="${aaGoods.goodsbarcode }" id="goodsBarCode" name="goodsBarCode"> </div>
							<div class="cf"></div> 
		 				</li>
		 				<li class="wordli fl">
							<div class="wordname fl">默认扫描数量：</div>
							<div class="wordnameinput fl"><input type="text" value="${aaGoods.scanNum }" id="scanNum" name="scanNum" > </div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="hidden" value="${aaGoods.goodssortuid }" id="goodsSortUid" name="goodsSortUid" > 
								<input type="text" value="${aaGoods.classificationName }" id="goodsSortName" name="goodsSortName"> 
							</div>
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl"><input type="text" value="${aaGoods.procureabovescale }" id="procureAboveScale" name="procureAboveScale"> </div>
							<div class="cf"></div> 
		 				</li>
		 				<li class="wordli fl">
							<div class="wordname fl">生产超订单入库比例：</div>
							<div class="wordnameinput fl"><input type="text" value="${aaGoods.produabovescale }" id="produAboveScale" name="produAboveScale"> </div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<select id="directStore" name="directStore">
									<c:if test="${aaGoods.directstore==1 }">
										<option value="0">否</option>
										<option value="1" selected="selected">是</option>
									</c:if>
									
									<c:if test="${aaGoods.directstore==0 }">
