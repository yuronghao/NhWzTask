	 ...
	 <div class="EMonecontent">
	 	...
	 	<div class="toolbar">
	 		<ul>
		 		...
		 		<li class="fl"><input type="button" id="test" class="tesst" value="测试"> </li>
	 			<div class="cf"></div>
	 		</ul>
	 	</div>
	 	...
	 	<div class="mainword">
	 		...
	 		<div class="xz_attribute"  >
	 			...
	 			<div class="fl" style="width:81%;margin-top: 20px;">
	 				<iframe src="${ctx }/wms/goods_getRightGoods.emi" frameborder="0" id="rightframe" name="rightframe" width="100%" style="margin-left:5px;min-height: 500px;"></iframe>
	 			</div>
