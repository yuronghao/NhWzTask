...
import com.emi.wms.synchro.dao.SynchroDaoU101;
import com.emi.wms.util.Constants;
import com.emi.wms.util.DateUtil;

public class SynchroServiceU101 extends EmiPluginService implements Serializable {

	private static final long serialVersionUID = -2162597524027074596L;
	private SynchroDaoU101 synchroDaoU101;
	...
	public void setSynchroDaoU101(SynchroDaoU101 synchroDaoU101) {
		this.synchroDaoU101 = synchroDaoU101;
	}
	...
	public void synchroInventoryClass(String orgGid,String sobGid){
		synchroDaoU101.deleteInventoryClass();//删除存货分类
		synchroDaoU101.addInventoryClass();//增加存货分类
		synchroDaoU101.updInventoryClass();//修改存货分类
		synchroDaoU101.updInventoryClassParentGid();//指定父id
		synchroDaoU101.updInventoryClassOrgSob(orgGid, sobGid);//指定帐套 组织
	}
	
	public void noTransynchroInventoryClass(String orgGid,String sobGid){
		int i=synchroDaoU101.deleteInventoryClass();//删除存货分类
		
		int j=synchroDaoU101.addInventoryClass();//增加存货分类
		
		int k=synchroDaoU101.updInventoryClass();//修改存货分类
	...
	public void synchroInventory(String orgGid,String sobGid){
		synchroDaoU101.deleteInventory();//删除存货档案
		synchroDaoU101.addInventory();//增加存货档案
		synchroDaoU101.updInventory();//修改存货档案
		synchroDaoU101.updInventoryInfor();//修改相关属性
		synchroDaoU101.updInventoryOrgSob(orgGid, sobGid);//指定帐套组织
	}
	
	public void noTransynchroInventory(String orgGid,String sobGid){
		int i=synchroDaoU101.deleteInventory();//删除存货档案
		int j=synchroDaoU101.addInventory();//增加存货档案
		int k=synchroDaoU101.updInventory();//修改存货档案
		synchroDaoU101.updInventoryInfor();//修改相关属性
		synchroDaoU101.updInventoryOrgSob(orgGid, sobGid);//指定帐套组织
	...
	public void synchroDepartment(String orgGid,String sobGid){
		synchroDaoU101.deleteDepartment();//删除部门
		synchroDaoU101.addDepartment();//增加部门
		synchroDaoU101.uptDepartment();//修改部门
		synchroDaoU101.uptDepartmentParentGid();//修改自关联字段
		synchroDaoU101.updDepartmentOrgSob(orgGid, sobGid);//指定帐套组织
	}
	
	public void noTransynchroDepartment(String orgGid,String sobGid){
		int i=synchroDaoU101.deleteDepartment();//删除部门
		int j=synchroDaoU101.addDepartment();//增加部门
		int k=synchroDaoU101.uptDepartment();//修改部门
		synchroDaoU101.uptDepartmentParentGid();//修改自关联字段
		synchroDaoU101.updDepartmentOrgSob(orgGid, sobGid);//指定帐套组织
		if(i>0 || j>0 || k>0){
	...
	public void synchroCustomer(String orgGid,String sobGid){
		synchroDaoU101.deleteCustomer();//删除客户
		synchroDaoU101.addCustomer();//增加客户
		synchroDaoU101.updCustomer();//修改客户
		synchroDaoU101.updCustomerOrgSob(orgGid, sobGid);//指定帐套组织
	}
	
	public void noTransynchroCustomer(String orgGid,String sobGid){
		int i=synchroDaoU101.deleteCustomer();//删除客户
		int j=synchroDaoU101.addCustomer();//增加客户
		int k=synchroDaoU101.updCustomer();//修改客户
		synchroDaoU101.updCustomerOrgSob(orgGid, sobGid);//指定帐套组织
	...
	public void synchroWareHouse(String orgGid,String sobGid){
		synchroDaoU101.deleteWareHouse();//删除仓库
		synchroDaoU101.addWareHouse();//增加仓库
		synchroDaoU101.updWareHouse();//修改仓库
		synchroDaoU101.updWareHouseOrgSob(orgGid, sobGid);
	}
	
	
	public void noTransynchroWareHouse(String orgGid,String sobGid){
		int i=synchroDaoU101.deleteWareHouse();//删除仓库
		int j=synchroDaoU101.addWareHouse();//增加仓库
		int k=synchroDaoU101.updWareHouse();//修改仓库
		synchroDaoU101.updWareHouseOrgSob(orgGid, sobGid);
	...
	public void synchroGoodsAllocation(String orgGid,String sobGid){
		...
		synchroDaoU101.addGoodsAllocation();//增加货位
		synchroDaoU101.updGoodsAllocation();//修改货位
		synchroDaoU101.updGoodsAllocationInfor();//修改相关属性
		synchroDaoU101.updGoodsAllocationOrgSob(orgGid, sobGid);
	}
	...
	public void noTransynchroGoodsAllocation(String orgGid,String sobGid){
		...
		//synchroDaoU8.deleteGoodsAllocation();//删除货位
		int i=synchroDaoU101.addGoodsAllocation();//增加货位
		int j=synchroDaoU101.updGoodsAllocation();//修改货位
		synchroDaoU101.updGoodsAllocationInfor();//修改相关属性
		synchroDaoU101.updGoodsAllocationOrgSob(orgGid, sobGid);
	...
	public void synchroUnit(String orgGid,String sobGid){
		synchroDaoU101.deleteUnit();//删除单位
		synchroDaoU101.addUnit();//增加单位
		synchroDaoU101.updUnit();//修改单位
		synchroDaoU101.updUnitOrgSob(orgGid, sobGid);//指定组织 帐套
	}
	
	public void noTransynchroUnit(String orgGid,String sobGid){
		int i=synchroDaoU101.deleteUnit();//删除单位
		int j=synchroDaoU101.addUnit();//增加单位
		int k=synchroDaoU101.updUnit();//修改单位
		synchroDaoU101.updUnitOrgSob(orgGid, sobGid);//指定组织 帐套
	...
	public void synchroProvider(String orgGid,String sobGid){
		synchroDaoU101.deleteProvider();//删除供应商
		synchroDaoU101.addProvider();//增加供应商
		synchroDaoU101.updProvider();//修改供应商
		synchroDaoU101.updProviderOrgSob(orgGid, sobGid);//指定组织 帐套
	}
	
	
	public void noTransynchroProvider(String orgGid,String sobGid){
		int i=synchroDaoU101.deleteProvider();//删除供应商
		int j=synchroDaoU101.addProvider();//增加供应商
		int k=synchroDaoU101.updProvider();//修改供应商
		synchroDaoU101.updProviderOrgSob(orgGid, sobGid);//指定组织 帐套
	...
	public void synchroUser(String orgGid,String sobGid){
		synchroDaoU101.addUser();//增加用户
		synchroDaoU101.updUser();//修改用户
		synchroDaoU101.updUserOrgSob(orgGid, sobGid);//指定组织 帐套
	}
	
	public void noTransynchroUser(String orgGid,String sobGid){
		int i=synchroDaoU101.addUser();//增加用户
		int j=synchroDaoU101.updUser();//修改用户
		synchroDaoU101.updUserOrgSob(orgGid, sobGid);//指定组织 帐套
		if(i>0 || j>0){
	...
	public void synchroPerson(String orgGid,String sobGid){
		synchroDaoU101.deletePerson();//删除人员
		synchroDaoU101.addPerson();//增加人员
		synchroDaoU101.updPerson();//修改人员
		synchroDaoU101.updPersonInfor();//修改相关属性
		synchroDaoU101.updPersonOrgSob(orgGid, sobGid);//指定组织 帐套
	}
	
	public void noTransynchroPerson(String orgGid,String sobGid){
		int i=synchroDaoU101.deletePerson();//删除人员
		int j=synchroDaoU101.addPerson();//增加人员
		int k=synchroDaoU101.updPerson();//修改人员
		synchroDaoU101.updPersonInfor();//修改相关属性
		synchroDaoU101.updPersonOrgSob(orgGid, sobGid);//指定组织 帐套
	...
	public void synchroRdStyle(String orgGid,String sobGid){
		synchroDaoU101.deleteRdStyle();//删除收发类别
		synchroDaoU101.addRdStyle();//增加收发类别
		synchroDaoU101.updRdStyle();//修改收发类别
		synchroDaoU101.updRdStyleOrgSob(orgGid, sobGid);//指定组织 帐套
	}
	
	
	public void noTransynchroRdStyle(String orgGid,String sobGid){
		int i=synchroDaoU101.deleteRdStyle();//删除收发类别
		int j=synchroDaoU101.addRdStyle();//增加收发类别
		int k=synchroDaoU101.updRdStyle();//修改收发类别
		synchroDaoU101.updRdStyleOrgSob(orgGid, sobGid);//指定组织 帐套
	...
	public void synchroUserDefine(String orgGid,String sobGid){
		synchroDaoU101.deleteUserDefine();//删除用户自定义项
		synchroDaoU101.addUserDefine();//增加用户自定义项
		synchroDaoU101.updUserDefine();//修改用户自定义项
		synchroDaoU101.updUserDefineOrgSob(orgGid, sobGid);//指定组织 帐套
	}
	...
	public void synchroWorkCenter(String orgGid,String sobGid){
		...
		synchroDaoU101.deleteWorkCenter();//删除工作中心
		synchroDaoU101.addWorkCenter();//增加工作中心
		synchroDaoU101.updWorkCenter();//修改工作中心
		synchroDaoU101.updWorkCenterInfor();//修改相关属性
		synchroDaoU101.updWorkCenterOrgSob(orgGid, sobGid);//指定组织 帐套
	}
	...
	public void synchroStandardprocess(String orgGid,String sobGid){
		synchroDaoU101.deleteStandardprocess();//删除标准工序
		synchroDaoU101.addStandardprocess();//增加标准工序
		synchroDaoU101.updStandardprocess();//修改标准工序
		synchroDaoU101.updStandardprocessOrgSob(orgGid, sobGid);//指定组织 帐套
	}
	...
	public void synchroProductStructure(){
		synchroDaoU101.deleteProductStructure();//删除产品结构主表
		synchroDaoU101.addProductStructure();//增加产品结构主表
		synchroDaoU101.updProductStructure();//修改产品结构主表
		synchroDaoU101.updProductStructureInfor();//修改关联字段
		
		synchroDaoU101.deleteProductStructurec();//删除产品结构子表
		synchroDaoU101.addProductStructurec();//增加产品结构子表
		synchroDaoU101.updProductStructurec();//修改产品结构子表
		synchroDaoU101.updProductStructurecInfor();//修改关联字段
	}
	...
	public void synchroProcessRoute(){
		synchroDaoU101.deleteProcessRoute();//删除工艺路线主表
		synchroDaoU101.addProcessRoute();//增加工艺路线主表
		synchroDaoU101.updProcessRoute();//修改工艺路线主表
		synchroDaoU101.updProcessRouteInfor();//修改关联字段
				
		synchroDaoU101.deleteProcessRouteC();//删除工艺路线子表
		synchroDaoU101.addProcessRouteC();//增加工艺路线子表
		synchroDaoU101.updProcessRouteC();//修改工艺路线子表
		synchroDaoU101.updProcessRouteCInfor();//修改关联字段
	}
...
//		List<Procurearrival> plToAdd=synchroDaoU8.getPl(condition);
		...
		List<ProcurearrivalC> plsToAdd=synchroDaoU101.getProcurearrivalC3(condition);//获得需要增加的到货单子表
		
		condition=" and pc.autoidForSynchro not in (select autoid from "+Config.BUSINESSDATABASE+"PU_ArrivalVouchs ) ";
		List<ProcurearrivalC> plsToDelete=synchroDaoU101.getProcurearrivalC1(condition);//获得需要删除的到货单子表
		
		condition=" and isnull(pc.needCheck,'')<>isnull(paus8.bGsp,'') or isnull(pc.define22,'')<>isnull(paus8.cdefine22,'') ";
		List<ProcurearrivalC> plsToUpd=synchroDaoU101.getProcurearrivalC2(condition);//获得需要修改的到货单子表
		...
		List<Procurearrival> plToAdd=synchroDaoU101.getPl(condition);
		...
		if(!CommonUtil.isNullObject(billIdentity)){
			...
			plsToAddSecond=synchroDaoU101.getProcurearrivalC3(condition);//获得发货单对应的到货单子表
		}
		...
		//////////////////////////////////////////////////////////////////////////////////////////处理订单主表
		synchroDaoU101.deleteProArrival();//删除到货单主表
		synchroDaoU101.addProArrival();//增加到货单主表
		synchroDaoU101.updProArrival();//修改到货单主表
		synchroDaoU101.updProArrivalInfor();//修改相关字段
		
		//////////////////////////////////////////////////////////////////////////////////////////处理订单子表
		synchroDaoU101.deleteProArrivalC();//删除到货单子表
		synchroDaoU101.addProArrivalC();//增加到货单子单
		synchroDaoU101.updProArrivalC();//修改到货单子单
		synchroDaoU101.updProArrivalCInfor();//修改关联字段
		synchroDaoU101.updProArrivalOrgSob(orgGid, sobGid);
		...
		if(!CommonUtil.isNullObject(billIdentity)){
			...
			synchroDaoU101.deleteTask(condition);
		}
		
		//生成入库任务 或者 质检任务
		if(tasks.size()>0){
			synchroDaoU101.createTask(tasks);
			synchroDaoU101.updateTaskInfor();//跟WM_BillType 做关联
			synchroDaoU101.updateTaskProArrivalBillGid();//修改采购出库对应billGid
		}
		
		//删除已经在u8中完成的任务
		synchroDaoU101.deleProArrivalInvalidTask();
	...
	public void synchroSaleSend(String orgGid,String sobGid) throws Exception{
		...
		List<SaleSendC> plsToAdd=synchroDaoU101.getSaleSendC3(condition);//获得需要增加的发货单子表
		
		condition=" and ssc.autoidForSynchro not in (select iDLsID from "+Config.BUSINESSDATABASE+"DispatchLists ) ";
		List<SaleSendC> plsToDelete=synchroDaoU101.getSaleSendC1(condition);//获得需要删除的发货单子表
		
		condition=" and  isnull(ssc.define22,'')<>isnull(dis.cdefine22,'') ";
		List<SaleSendC> plsToUpd=synchroDaoU101.getSaleSendC2(condition);//获得需要修改的发货单子表
		...
		List<SaleSend> ssToAdd=synchroDaoU101.getSs(condition);
		...
		if(!CommonUtil.isNullObject(billIdentity)){
			...
			plsToAddSecond=synchroDaoU101.getSaleSendC3(condition);//获得删除的发货单对应的到货单子表
		}
...
//					}
		...
		//////////////////////////////////////////////////////////////////////////////////////////处理订单主表
		synchroDaoU101.deleteSaleSend();//删除发货单主表
		synchroDaoU101.addSaleSend();//增加发货单主表
		synchroDaoU101.updSaleSend();//修改发货单主表
		synchroDaoU101.updSaleSendInfor();//修改相关字段
		
		//////////////////////////////////////////////////////////////////////////////////////////处理订单子表
		synchroDaoU101.deleteSaleSendC();//删除发货单子表
		synchroDaoU101.addSaleSendC();//增加发货单子表
		synchroDaoU101.updSaleSendC();//修改发货单子表
		synchroDaoU101.updSaleSendCInfor();//修改相关字段
		synchroDaoU101.updSaleSendOrgSob(orgGid, sobGid);
		...
		if(tasks.size()>0){
			synchroDaoU101.createTask(tasks);
			synchroDaoU101.updateTaskInfor();//跟WM_BillType 做关联
			synchroDaoU101.updateTaskSaleSendBillGid();//修改销售出库对应billGid
		}
	...
	public void synchroProduceOrder(String orgGid,String sobGid){
		//////////////////////////////////////////////////////////////////////////////////////////处理订单主表
		synchroDaoU101.deleteProduceOrder();//删除生产订单主表
		synchroDaoU101.addProduceOrder();//增加生产订单主表
		synchroDaoU101.updProduceOrder();//修改生产订单主表
		
		//////////////////////////////////////////////////////////////////////////////////////////处理订单产品表
		synchroDaoU101.deleteProduceOrderC();//删除生产订单产品表
		synchroDaoU101.addProduceOrderC();//增加生产订单产品表
		synchroDaoU101.updProduceOrderC();//修改生产订单产品表
		synchroDaoU101.updProduceOrderCInfor();//修改生产订单产品表相关字段
		
		//////////////////////////////////////////////////////////////////////////////////////////处理订单材料表
		synchroDaoU101.deleteProduceOrderC2();//删除生产订单材料表
		synchroDaoU101.addProduceOrderC2();//增加生产订单材料表
		synchroDaoU101.updProduceOrderC2();//修改生产订单材料表
		synchroDaoU101.updProduceOrderC2Infor();//修改相关字段
		
		synchroDaoU101.updProduceOrderOrgSob(orgGid, sobGid);//指定组织 帐套
	...
	public String getWarehousePos(){
		...
		List<AaWarehouse> aaWarehouse=synchroDaoU101.getAaWarehouse(condition);//启用货位的仓库
	...
	public String getWarehouseNoPos(){
		...
		List<AaWarehouse> aaWarehouse=synchroDaoU101.getAaWarehouse(condition);//不启用货位的仓库
	...
	public void synchroAllocationStock(String orgGid,String sobGid){
		...
		if(!CommonUtil.isNullObject(whCodeNoPos)){
			wasYonYou=synchroDaoU101.getWasYonYou(noPosYonYouCondition);//从用友中查询不启用货位的库存
		}
		
		String noPosWmsCondition=" whCode in "+whCodeNoPos;
		List<WmAllocationstock> wasWms=new ArrayList<WmAllocationstock>();
		if(!CommonUtil.isNullObject(whCodeNoPos)){
			wasWms=synchroDaoU101.getWasWms(noPosWmsCondition);//从wms中查询不启用货位的库存
		}
...
//						toDeleteNoPos.add(ww);
		...
		List<WmAllocationstock> wasYonYouPos=synchroDaoU101.getWasYonYouPos("");//从用友中查询启用货位的库存
		...
		if(whCodePos.length()>0){
			...
			wasWmsPos=synchroDaoU101.getWasWms(posWmsCondition);//从wms中查询启用货位的库存
		}
...
//						toDeletePos.add(ww);
		...
		if(toDeleteNoPos.size()>0){
			synchroDaoU101.deleteWmAllocationstock(toDeleteNoPos);
		}
		if(toDeletePos.size()>0){
			synchroDaoU101.deleteWmAllocationstock(toDeletePos);
		}
		
		//修改
		if(toUpdateNoPos.size()>0){
			synchroDaoU101.updateWmAllocationstock(toUpdateNoPos);
		}
		
		if(toUpdtePos.size()>0){
			synchroDaoU101.updateWmAllocationstock(toUpdtePos);
		}
		
		//增加
		if(toAddNoPos.size()>0){
			synchroDaoU101.insertWmAllocationstock(toAddNoPos,orgGid,sobGid);
		}
		if(toAddPos.size()>0){
			synchroDaoU101.insertWmAllocationstock(toAddPos,orgGid,sobGid);
		}
		
		//修改关联字段
		synchroDaoU101.updWmAllocationstockInfor();
	...
	public void synchroOmOrder(String orgGid,String sobGid){
		...
		List<OM_MOMaterials> omToAdd=synchroDaoU101.getOMMaterials3(condition);//获得需要增加的材料单子表
		
		condition=" and om.mOMaterialsIDForSynchro not in (select MOMaterialsID from "+Config.BUSINESSDATABASE+"OM_MOMaterials ) ";
		List<OM_MOMaterials> omToDelete=synchroDaoU101.getOMMaterials1(condition);//获得需要删除的材料单子表
		
		condition=" and isnull(mwms.stateForSynchro,-1)<>isnull(myy.cState,0) ";//获得需要修改的委外订单主表 (主表审核状态发生变化的记录)
		List<OM_MOMain> omToUpd=synchroDaoU101.getMOMain(condition);
		...
		if(!CommonUtil.isNullObject(billIdentity)){
			...
			omsToAddSecond=synchroDaoU101.getOMMaterials3(condition);//获得发货单对应的到货单子表
		}
		...
		//////////////////////////////////////////////////////////////////////////////////////////处理委外订单主表
		synchroDaoU101.deleteOmOrder();//删除委外订单主表
		synchroDaoU101.addOmOrder();//增加委外订单主表
		synchroDaoU101.updOmOrder();//修改委外订单主表
		synchroDaoU101.updOmOrderInfor();//修改委外订单主表相关字段
		
		//////////////////////////////////////////////////////////////////////////////////////////处理委外订单产品表
		synchroDaoU101.deleteOmDetails();//删除委外订单产品表
		synchroDaoU101.addOmDetails();//增加委外订单产品表
		synchroDaoU101.updOmDetails();//修改委外订单产品表
		synchroDaoU101.updOmDetailsInfor();//修改委外订单产品表相关字段
		
		//////////////////////////////////////////////////////////////////////////////////////////处理委外订单材料表
		synchroDaoU101.deleteOMMaterials();//删除委外订单材料表
		synchroDaoU101.addOMMaterials();//增加委外订单材料表
		synchroDaoU101.updOMMaterials();//修改委外订单材料表
		synchroDaoU101.updOMMaterialsInfor();//修改相关字段
		synchroDaoU101.updOmOrderOrgSob(orgGid, sobGid);//指定组织 帐套
		...
		if(tasks.size()>0){
			synchroDaoU101.createTask(tasks);
			synchroDaoU101.updateTaskInfor();//跟WM_BillType 做关联
			synchroDaoU101.updateTaskMeterialOutBillGid();//修改委外材料出库对应billGid
		}
